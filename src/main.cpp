...
int64_t GetBlockValue(int nHeight)
{
    ...
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 2000000  ) {
     nSubsidy = 5000 * COIN;
    }
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 1000000 ) {
     nSubsidy = 2000 * COIN;
    }
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 550000) {
     nSubsidy = 5000 * COIN;
    }
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 500000) {
     nSubsidy = 8000 * COIN;
    }
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 40000) {
     nSubsidy = 5000 * COIN;
    }
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 28000) {
     nSubsidy = 6000 * COIN;
    }
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 14000) {
     nSubsidy = 7000 * COIN;
    }
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 7000) {
     nSubsidy = 8000 * COIN;
    }
